...
import { Directive, DirectiveTargetElement, FieldDefinition, InterfaceType, ObjectType, Schema, SchemaRootKind, Variables, VariableDefinitions, CompositeType, DeferDirectiveArgs, Variable } from "@apollo/federation-internals/src/definitions";
import { SetMultiMap } from "@apollo/federation-internals/src/utils";
