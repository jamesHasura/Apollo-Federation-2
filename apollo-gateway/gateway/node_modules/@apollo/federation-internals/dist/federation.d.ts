import { CompositeType, CoreFeature, Directive, DirectiveDefinition, FieldDefinition, InputFieldDefinition, InterfaceType, NamedType, ObjectType, ScalarType, Schema, SchemaBlueprint, SchemaConfig, SchemaElement, UnionType } from "@apollo/federation-internals/src/definitions";
import { SDLValidationRule } from "graphql/validation/ValidationContext";
import { ASTNode, DocumentNode, GraphQLError } from "graphql";
import { SelectionSet } from '@apollo/federation-internals/src/operations';
import { ErrorCodeDefinition } from "@apollo/federation-internals/src/error";
import { PrintOptions as PrintOptions } from "@apollo/federation-internals/src/print";
...
export declare const anyTypeSpec: import("@apollo/federation-internals/src/directiveAndTypeSpecification").TypeSpecification;
export declare const serviceTypeSpec: import("@apollo/federation-internals/src/directiveAndTypeSpecification").TypeSpecification;
export declare const entityTypeSpec: import("@apollo/federation-internals/src/directiveAndTypeSpecification").TypeSpecification;
export declare const FEDERATION_OPERATION_TYPES: import("@apollo/federation-internals/src/directiveAndTypeSpecification").TypeSpecification[];
