...
import { OpPathTree } from "@apollo/query-graphs/src/pathTree";
import { Vertex, QueryGraph, Edge, RootVertex } from "@apollo/query-graphs/src/querygraph";
import { Transition } from "@apollo/query-graphs/src/transition";
import { PathContext } from "@apollo/query-graphs/src/pathContext";
export declare class GraphPath<TTrigger, RV extends Vertex = Vertex, TNullEdge extends null | never = never> implements Iterable<[Edge | TNullEdge, TTrigger, OpPathTree | null]> {
    ...
    readonly deferOnTail?: DeferDirectiveArgs | undefined;
    private constructor();
