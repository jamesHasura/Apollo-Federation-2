...
import { SupergraphManager, SupergraphSdlHookOptions } from '@apollo/gateway/src/config';
export declare type FailureToFetchSupergraphSdlFunctionParams = {
    error: Error;
    graphRef: string;
    logger: Logger;
    fetchCount: number;
};
export declare type FailureToFetchSupergraphSdlDuringInit = ({ error, graphRef, logger, fetchCount, }: FailureToFetchSupergraphSdlFunctionParams) => Promise<string>;
export declare type FailureToFetchSupergraphSdlAfterInit = ({ error, graphRef, logger, fetchCount, mostRecentSuccessfulFetchAt, }: FailureToFetchSupergraphSdlFunctionParams & {
